...
public class ModuleDescriptions {
    public static String getDescription(Module module) {
        if (module instanceof ItemPhysic) return "Changes dropped-item rendering so items look physical on the ground.";
        if (module instanceof SoundBoard) return "Центральная панель выбора и прослушивания звуков интерфейса и модулей.";
        if (module instanceof HitSounds) return "Проигрывает настраиваемый звук при ударе по сущности.";
        ...
        if (module instanceof Trails) return "Оставляет короткий визуальный след за игроками при движении.";

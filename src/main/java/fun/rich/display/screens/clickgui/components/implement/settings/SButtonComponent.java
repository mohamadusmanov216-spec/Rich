...
//        Fonts.getSize(12).drawString(context.getMatrices(), wrapped, x + 9, y + 15, 0xFF878894);
        ...
        String buttonText = setting.getButtonName() == null || setting.getButtonName().isEmpty() ? "Preview" : setting.getButtonName();
        ((ButtonComponent) buttonComponent.setText(buttonText)
